...
import { SubcategoriaTicket } from './subcategoria-ticket.models';

@Component({
  selector: 'app-subcategoria-ticket-list',
  templateUrl: './subcategoria-ticket-list.component.html'
})
export class SubcategoriaTicketListComponent {
  readonly subcategorias = input.required<SubcategoriaTicket[]>();
  ...
  readonly edit = output<SubcategoriaTicket>();
  readonly delete = output<SubcategoriaTicket>();
